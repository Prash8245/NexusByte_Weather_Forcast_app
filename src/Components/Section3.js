        ...
        <div className='row'>
            <div className='col-2'>
                <div>
                    ...
                    <p>{props.data.forecast.forecastday[0].date}</p>
            ...
            <div className='col-2'>
                <div>
                    ...
                    <p>{props.data.forecast.forecastday[1].date}</p>
            ...
            <div className='col-2'>
                <div>
                    ...
                    <p>{props.data.forecast.forecastday[2].date}</p>
            ...
            <div className='col-2'>
                <div>
                    ...
                    <p>{props.data.forecast.forecastday[3].date}</p>
            ...
            <div className='col-2'>
                <div>
                    ...
                    <p>{props.data.forecast.forecastday[4].date}</p>
            ...
            <div className='col-2'>
                <div>
                    ...
                    <p>{props.data.forecast.forecastday[5].date}</p>
